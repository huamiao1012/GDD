...
def main():
    ...
    if 'dwd' in args.config:
        ...
        config_list = [
            # 'DG/_base_/datasets/domain_generalization/test_cityscapes.py',
            'DG/_base_/datasets/domain_generalization/test_bdd100k.py',
            'DG/_base_/datasets/domain_generalization/test_foggy_cityscapes.py',
            'DG/_base_/datasets/domain_generalization/test_rainy_cityscapes.py'
        ]
    elif 'sim10k' in args.config:
        config_list = [
            # 'DG/_base_/datasets/domain_generalization/test_sim10k.py',
            'DG/_base_/datasets/domain_generalization/test_cityscapes_for_sim10k.py',
            'DG/_base_/datasets/domain_generalization/test_bdd100k_for_sim10k.py'
        ]
